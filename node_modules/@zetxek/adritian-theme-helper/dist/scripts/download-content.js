...
function copyFiles(files) {
    files.forEach((file) => {
        ...
        if (fs.existsSync(sourcePath)) {
            ...
            (0, child_process_1.execFileSync)('cp', [sourcePath, targetPath]);
        }
        else {
...
function adritianDownloadContent(dirsToDownload = ALL_DIRS, options = {}) {
    try {
        ...
        dirsToDownload
            ...
            if (fs.existsSync(sourcePath)) {
                ...
                if (fs.existsSync(targetPath)) {
                    (0, child_process_1.execFileSync)('rm', ['-rf', targetPath]);
                }
                // Copy directory
                console.log(`Copying ${dir}...`);
                (0, child_process_1.execFileSync)('cp', ['-r', sourcePath, targetPath]);
            }
            else {
        ...
        (0, child_process_1.execFileSync)('rm', ['-rf', TEMP_DIR]);
